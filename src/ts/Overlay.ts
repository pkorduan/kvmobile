...
export class Overlay {
    ...
    getUrl = function () {
        ...
        url += file + "Stelle_ID=" + this.stelle.get("Stelle_ID") + "&" + "login_name=" + this.stelle.get("login_name") + "&" + "selected_layer_id=" + this.get("id") + "&" + "passwort=" + encodeURIComponent(this.stelle.get("passwort")) + "&go=Daten_Export_Exportieren&export_format=GeoJSONPlus&all=1&epsg=4326";
