...
export const kvm = {
    ...
    map: <L.Map>undefined,
    activeStelle: <any>undefined,
    activeLayer: <any>undefined,
    myRenderer: <L.Renderer>undefined,
    db: <any>undefined,
...
*/
    ...
    loadDeviceData: function () {
        ...
        $("#deviceDataText").html("kvmobile Version: " + kvm.version + "<br>" + "Cordova Version: " + device.cordova + "<br>" + "Modell: " + device.model + "<br>" + "Platform: " + device.platform + "<br>" + "Uuid: " + device.uuid + "<br>" + "Android Version: " + device.version + "<br>" + "Hersteller: " + device.manufacturer + "<br>" + "Seriennummer: " + device.serial);
    },
...
*/
    ...
    alog: function (msg, arg: any = "", level = 3, show_in_sperr_div = false) {
    ...
    now: function () {
        ...
        return now.getFullYear() + "-" + String("0" + (now.getMonth() + 1).toString()).slice(-2) + "-" + String("0" + now.getDate()).slice(-2) + "T" + String("0" + now.getHours()).slice(-2) + ":" + String("0" + now.getMinutes()).slice(-2) + ":" + String("0" + now.getSeconds()).slice(-2) + "Z";
    },

    now_local: function () {
        var now = new Date();
        // TODO falsch implementiert
        return now.getFullYear() + "-" + String("0" + (now.getMonth() + 1).toString()).slice(-2) + "-" + String("0" + now.getDate()).slice(-2) + "T" + String("0" + now.getHours()).slice(-2) + ":" + String("0" + now.getMinutes()).slice(-2) + ":" + String("0" + now.getSeconds()).slice(-2);
    },
