    ...
    load: function () {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                $('#gpsCurrentPosition').html('Position: ' + position.coords.latitude.toString() + ' ' + position.coords.longitude.toString()
                    + '<br>Genauigkeit: ' + position.coords.accuracy
                    + '<br>Zeit: ' + timestamp.toLocaleDateString() + ' ' + timestamp.toLocaleTimeString());
            });
        }
        else {
...
//# sourceMappingURL=gpsStatus.js.map